...
export interface ICompanyInfo extends Document {
    ...
    logoLocalUrl: string;       // server URL as fallback
...
const companyInfoSchema = new mongoose.Schema(
    {
        ...
        officeTelephone: { type: String, required: true, trim: true },
        emails: {
            type: [String],
            required: true,
            validate: {
        ...
        logoLocalPath: { type: String, required: true },  
        logoLocalUrl: { type: String, required: true },   
        socialLinks: { type: socialLinksSchema, default: {} },
        mapLatitude: { type: Number, required: true },
        mapLongitude: { type: Number, required: true },
